...
public class AccountController {
    ...
    public void changePassword(@PathVariable String customerId, @PathVariable String oldPassword,@PathVariable String newPassword) {
        accountService.changePassword(customerId, oldPassword, newPassword);
    }

    @PostMapping("/transfer")
    public boolean transfer(@RequestParam String fromAccountNumber, @RequestParam String toAccountNumber, @RequestParam double amount) {
